...
struct STracingRay // for shadows
{
    SRay ray;
    float contribution;
    int depth;
...
void initializeDefaultScene(out STriangle triangles[13], out SSphere spheres[2])
{
    ...
    //Spheres . . . . . . . . . . . . . . . . .
    spheres[0].Center = vec3(-2.5, 1.7, 6.0);
    spheres[0].Radius = 5;
...
void initializeDefaultLightMaterials(out SLight light, out SMaterial materials[10])
{
    ...
    // Front wall material (mirror-purple)
    materials[1].Color = vec3(0.3, 0.3, 1.0);
    ...
    // (Green)
    materials[4].Color = vec3(0.1, 0.5, 0.1);
    ...
    // (Yellow)
    materials[5].Color = vec3 (1, 0.6, 0.3);
    ...
    materials[6].ReflectionCoef = mirrorCoeff;
